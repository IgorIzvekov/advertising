...
const NewCard = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (theme === "Enter channel topic") {
      validationErrors.theme = "Please enter the channel topic";
    }
    if (!language) {
      validationErrors.language = "Please enter the language";
    }
    if (language === "Enter channel language") {
      validationErrors.language = "Please enter the language";
    }
    if (!description) {
    ...
    if (geo === "Select channel geolocation") {
      validationErrors.geo = "Please enter the channel geo";
    }

    if (type === "Select channel type") {
      validationErrors.type = "Please enter the channel type";
    }
          ...
          <label className="modal-label">
            ...
            <div className="flex">
              ...
              <select
                ...
                onChange={(e) => setType(e.target.value)}
              >
                <option value="Select channel type">other</option>
          ...
          <label className="modal-label">
            ...
            <div className="flex">
              ...
              <select
                ...
                onChange={(e) => setGeo(e.target.value)}
              >
                <option value="Select channel geolocation">other</option>
                {geos && geos.length > 0
                  ? geos.map((item) => (
                      <option key={Math.random()} className="" value={item}>
                        {item}
          ...
          <label className="modal-label">
            ...
            <div className="flex">
              ...
              <select
                ...
                onChange={(e) => setTheme(e.target.value)}
              >
                <option value="Enter channel topic">other</option>
          ...
          <label className="modal-label">
            ...
            <div className="flex">
              ...
              <select
                ...
                onChange={(e) => setLanguage(e.target.value)}
              >
                <option value="Enter channel language">other</option>
                {lang && lang.length > 0
                  ? lang.map((item) => (
                      <option key={item} className="" value={item}>
                        {item}
